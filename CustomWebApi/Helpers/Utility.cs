...
public class Utility : System.Web.UI.Page
{
    ...
    public string MakeWebSiteCallFromHandler(string formContent)
    {
        ...
        string ApiURL = Constants.PayTabsSiteUrl;
    ...
    public string MakeRefund(MakePaymentModel.RefundRequest objRefundRequest)
    {
    ...
    public string ReturnTransactionReport(MakePaymentModel.ReportRequest objReportRequest)
    {
    ...
    public string PayTabsIPN(MakePaymentModel.ReportRequest objReportRequest)
    {
        return "merchant_email=" + objReportRequest.MerchantEmail
                + "&secret_key=" + objReportRequest.SecretKey;
    }
