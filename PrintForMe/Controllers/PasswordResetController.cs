    ...
    public class PasswordResetController : Controller
    {
        ...
        public async Task<ActionResult> RequestPasswordReset(RequestPasswordResetViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, ResHelper.GetString("PrintForMe.PasswordReset.Email.Subject"),
                    String.Format(ResHelper.GetString("PrintForMe.PasswordReset.Email.Body"), resetUrl));
            }
