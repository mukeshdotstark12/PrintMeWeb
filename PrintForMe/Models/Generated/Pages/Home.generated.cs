...
namespace CMS.DocumentEngine.Types.PrintForme
{
	...
	public partial class Home : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "PrintForme.Home";
		...
		public string LandingImage
		{
			get
			{
				return ValidationHelper.GetString(GetValue("LandingImage"), @"");
			}
			set
			{
				SetValue("LandingImage", value);
			}
		}
		...
		public string HeadingTitle
		{
			get
			{
				return ValidationHelper.GetString(GetValue("HeadingTitle"), @"");
			}
			set
			{
				SetValue("HeadingTitle", value);
			}
		}
		...
		public partial class HomeFields : AbstractHierarchicalObject<HomeFields>
		{
			...
			public string LandingImage
			{
				get
				{
					return mInstance.LandingImage;
				}
				set
				{
					mInstance.LandingImage = value;
				}
			}
			...
			public string HeadingTitle
			{
				get
				{
					return mInstance.HeadingTitle;
				}
				set
				{
					mInstance.HeadingTitle = value;
				}
			}
