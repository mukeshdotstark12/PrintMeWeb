...
namespace CMS.DocumentEngine.Types.PrintForMe
{
	...
	/// </summary>
	public partial class Products : SKUTreeNode
	{
		...
		{
		    /// <summary>
			/// The content item of type <see cref="Products" /> that is a target of the extended API.
			/// </summary>
			private readonly Products mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="Products" /> .
			/// </summary>
			/// <param name="instance">The content item of type Products that is a target of the extended API.</param>
			public ProductFields(Products instance)
			{
				mInstance = instance;
			}
