...
return false;";
    ...
    private void LoadObjects()
    {
        ...
        if (url != null)
        {
            ...
            mJavaScript.Append("function US_SelectionDialog_", UniSelectorClientID, "(values) { ", Page.ClientScript.GetCallbackEventReference(this, "values", "US_SelectionDialogReady_" + UniSelectorClientID, "'" + HttpUtility.JavaScriptStringEncode(ScriptHelper.ResolveUrl(url)) + "'"), "; } \n");
